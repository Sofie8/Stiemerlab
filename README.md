# Stiemerlab
Bekijk [hier](https://sofiethijs.shinyapps.io/Stiemerlab_v1/) de gedetailleerde resultaten van de biologische waterkwaliteit van de Stiemerbeek, gemeten voor en door burgers van Genk.  
...
Doel van het [Stiemerlab](https://stiemerlab.be/over-stiemerlab/) project:
...
- De technieken gebruikt in dit project zijn o.a. het nemen van water schepstalen voor eDNA-analyse met next-generation sequencing, en fytoplanktonstalen voor FLOWCAM-analyse.
...
- Ten tweede willen we het meetnet gevoelig uitbreiden, door niet op 1, maar op 10 locaties te meten. Daarnaast willen we ook de frequentie opvoeren (niet 1 keer per jaar, maar maandelijks). Op die manier krijgen we voor het eerst inzichten in de ruimtelijke en seizoenale dynamiek van de waterloop. 
...
<img src="https://github.com/Sofie8/Stiemerlab/blob/main/fotos/StiemerLab_Test2_BoumedieneBelbachir019.JPG" width="350px"> 
